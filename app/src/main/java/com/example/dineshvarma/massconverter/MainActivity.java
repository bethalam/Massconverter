...
public class MainActivity extends AppCompatActivity {
    ...
    String[] names={"Tonne", "Kilogramme", "Gramme", "milligramme", "Microgramme", "Quintal", "Pound", "Ounce", "Carat", "Grain", "Stone", "Dram", "Dan", "Jin", "Qian"};
    double[] values = {1.0, 1000, 1000000, 1000000000, 1000000000000.0, 10, 2204.62262, 35273.9619, 5000000, 15432358.4, 157.473044, 564383.391, 20, 2000, 200000};
